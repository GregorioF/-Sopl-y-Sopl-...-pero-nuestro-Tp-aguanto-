...
; ecx = cantidad de filas
	...
	.ciclo:
		...
		shr r10, 4 ; shifteo a la derecha 4 bytes
		mov r9d, r10d ; muevo la parte alta

		mov r11b, r8b ; muevo el a
		shr r8d, 1 ; shifteo 1 byte
		mov r12b, r8b ; muevo el b
		shr r8d, 1
		mov r13b, r8b ; muevo el g
		shr r8d, 1
		mov r14b, r8b ; muevo el r
