...
\subsection{Código ASM}
	...
	En la implementación de ASM recorremos las filas de la imagen; tenemos dos ciclos, el interno recorre una fila iterando sobre sus columnas, y el externo itera sobre todas las filas de la imagen.\\
	En el ciclo interno cargamos 8 píxeles, nos encargamos de ubicarlos en un registro xmmi a nuestra conveniencia utilizando \textbf{pshufd}, \textbf{psrldq}, \textbf{pslldq} y \textbf{paddb}.\\
	En un principio cargamos los primeros 4 píxeles en \textbf{xmm1} y luego \textbf{pshud xmm1, xmm1,0xd8}. \\
	\textbf{xmm1:}
