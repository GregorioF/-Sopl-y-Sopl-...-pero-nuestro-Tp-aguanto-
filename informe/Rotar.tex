...
\par{Efectivamente vimos una notoria diferencia entre el código en ASM con y sin SIMD, más aún, el código optimizado de C se encuentra casi a la par. EXLICACION DEL CODIGO SIN SIMD!!!!}
